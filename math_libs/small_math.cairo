#this utility library extends/wraps/types on top of influence/cairo-math-64x61 fixed point library
...
# Multiplies two fixed point values and checks for overflow before returning
...
# ORIGINAL COMMENTS:
# Calculates the value of x^y and checks for overflow before returning
